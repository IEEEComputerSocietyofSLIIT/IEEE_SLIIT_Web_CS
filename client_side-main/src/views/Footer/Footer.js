...
const Footer = () => {
  return (
    ...
    <footer className="max-w-screen-xl mx-auto">
      <div className="flex-col lg:flex px-5 pt-10 pb-4 md:px-10 ">
        {/* TOP CONTAINER */}
        <div className="lg:flex lg:flex-row lg:justify-between">
          ...
          <div className="flex grow flex-row flex-wrap lg:mx-10 lg:flex-nowrap lg:justify-center">
            ...
            <div className="my-5 mr-8 flex max-w-52 grow basis-24 flex-col space-y-5 lg:mx-10 lg:mt-0">
              <h2 className="font-inter font-medium text-black">Useful Links</h2>
              <a href="/" className="font-inter font-light text-gray-500">
                Home
              </a>
              <a href="/user/aboutus" className="font-inter font-light text-gray-500">
                About Us
              </a>
              <a href="/user/contactus" className="font-inter font-light text-gray-500">
                Contact Us
              </a>
             
              <a href="/user/communityDetails" className="font-inter font-light text-gray-500">
                Community Details
              </a>
          ...
          {/* LINK BLOCK */}
          <div className="my-5 mr-8 flex max-w-52 grow basis-24 flex-col space-y-5 lg:mx-10 lg:mt-0">
              <h2 className="font-inter font-medium text-black">News Feed</h2>
              <a href="/user/events" className="font-inter font-light text-gray-500">
              Events
              </a>
              <a href="/user/news" className="font-inter font-light text-gray-500">
              News
              </a>
              <a href="/user/gallery" className="font-inter font-light text-gray-500">
              Gallery
              </a>
          ...
          {/* LOCATION & SUPPORT */}
          <iframe
                        className="rounded-xl w-full md:w-1/4 h-full"
        ...
        {/* DIVIDER */}
        <div className="mx-auto my-2 w-full border border-gray-300 lg:my-4"></div>
        {/* COPYRIGHT TEXT */}
        <div>
