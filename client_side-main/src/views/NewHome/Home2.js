        ...
        <div className="Home">
            <div class="relative bg-white h-[90vh] text-white overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col px-[24px] mx-auto justify-center items-center h-full text-center text-[#FFA300] drop-shadow-2xl">
                    ...
                    <p class="text-lg text-gray-300 mb-8 text-center font-bold drop-shadow-2xl">
                        Embrace the opportunity to Join our community and make your mark in <br />
                        Computer Science with the <span>Institute of Electrical and Electronics Engineers</span> (IEEE) <br />
                        Computer Society of <span>Sri Lanka Institute of Information Technology</span> (SLIIT)
                    </p>
                    <button 
                        onClick={scrollToAbout} 
                        class="bg-white w-fit text-gray-900 hover:bg-white py-2 px-6 rounded-full text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg drop-shadow-2xl">
                        Explore
                    </button>
                </div>
            </div>

            <div id='about' className="grid md:flex gap-10 md:gap-20 my-28 w-4/5 mx-auto justify-center items-center">
                <img src="./images/who-we-are.png" alt="Who We Are" className='w-full md:w-2/5 h-fit' />
                <div className="grid w-full md:w-1/2 items-center">
                    ...
                    <p className='text-center md:text-left'>
                        We are the IEEE Computer Society at SLIIT, <br />a community passionate about computer science. <br /><br />
                        Our mission is to promote innovation, networking, and knowledge sharing. We are here to give you the opportunity and make a difference as a volunteer in the world of tech.
                    </p>
                </div>
            </div>

            <div class="bg-[#00629B]">
                <div class="grid max-w-screen-xl lg:grid-cols-2 items-center max-lg:justify-center gap-10 h-full sm:p-12 p-8 mx-auto max-sm:p-4">
